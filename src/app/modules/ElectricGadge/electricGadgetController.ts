...
export const addElectricGadget = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const addAdminElectricGadget = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const deleteElectricGadget = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const updateElectricGadget = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    //console.error('Error updating electric gadget:', error);
    next(error);
  }
};

export const getAllElectricGadgets = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    const electricGadgets = await ElectricGadgetModel.find().populate({
      path: 'createdBy',
    ...
    const filters: FilterOptions = {
      ...
      // ? new Date(req.query.releaseDate as string)
      // : undefined,
    ...
    // Apply filters to electric gadgets
...
export const bulkDeleteElectricGadgets = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const getElectricGadgetById = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    const electricGadget = await ElectricGadgetModel.findById(
      electricGadgetId,
    ).populate({
      path: 'createdBy',
      select: '-password -passwordChangeHistory',
